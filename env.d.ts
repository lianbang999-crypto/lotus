/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 3ed3793fd0b056ca93a9e2add1e12eab)
...
interface __BaseEnv_Env {
	...
	DEV_LOCAL: string;
	LotusAgent: DurableObjectNamespace /* LotusAgent */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WENCHAO_API_URL" | "MODEL_NAME" | "DEV_LOCAL">> {}
}
