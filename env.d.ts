/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 3d7fc906611f140da42cd0f9546fe3e2)
// Runtime types generated with workerd@1.20260911.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	VOICE_AUDIO: R2Bucket;
	AI: Ai;
	WENCHAO_API_URL: "https://wenchao.foyue.org/api/retrieve";
	DEV_LOCAL: string;
	OPENAI_API_KEY: string;
	OPENAI_BASE_URL: string;
	MODEL_NAME: string;
	LotusAgent: DurableObjectNamespace<import("./src/server").LotusAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "LotusAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WENCHAO_API_URL" | "DEV_LOCAL" | "OPENAI_API_KEY" | "OPENAI_BASE_URL" | "MODEL_NAME">> {}
}
